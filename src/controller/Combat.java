...
public class Combat
{
	...
	public void battle(Player player, int minIndex, int maxIndex, int oldRoom, Room room)
		...
		for (int i = 0; i < monsterList.size(); i++)
		{
			...
			do
			{
				...
				while (!playerDead && !monsterDead)
				{
					...
					player.slowText("+------------------------------------------------------------------+");
					player.slowText(
							"A " + monster.getMonsterName() + " has " + monster.getHitPoints() + " health left");
	...
	public void battleBoss(Player player, int minIndex, int maxIndex, int oldRoom, Room room)
			throws SQLException, ClassNotFoundException
	{
