 ...
 *
 *           This class is the Quest class handling business logic for the Quest
 *           class
 */
public class Quest
{
	...
	/**
	 * Method: getQuest Purpose: Gets a specified quest from the Quest table
	 * 
	 * @param id
	 * @return Quest
	 * @throws SQLException
	...
	/**
	 * Method: getAllQuests Purpose: gets all quests from the Quest table
	 * 
