 ...
 *
 * This class is the Weapon class handling business logic for the Weapon class
 */
public class Weapon
{
	...
	/** Method: getWeapon
	 * Purpose: Gets a specified weapon from the Weapon table 
	 * @param id
	 * @return Weapon
	 * @throws SQLException
	 */
	 ...
	 * Purpose: gets all weapons from the Weapon table
	...
	/**
	 * @param commonDamage the commonDamage to set
	 */
	...
	/**
	 * @param uncommonDamage the uncommonDamage to set
	 */
	...
	/**
	 * @param rareDamage the rareDamage to set
	 */
	...
	/**
	 * @param legendaryDamage the legendaryDamage to set
	 */
