 ...
 *
 *           This class is the Armor class handling business logic for the
 *           Potion class
 */
public class Potion
{
	...
	/**
	 * Method: getPotion Purpose: Gets a specified potion from the Potion table
	 * 
	 * @param id
	 * @return Potion
	 * @throws SQLException
	...
	/**
	 * Method: getAllPotion Purpose: gets all potions from the Potion table
	 * 
