 ...
 *
 * This class is the Armor class handling business logic for the Armor class
 */
public class Armor
{
	private int armorID;
	...
	/** Method: getArmor
	 * Purpose: Gets a specified armor from the Armor table 
	 * @param id
	 * @return Armor
	 * @throws SQLException
	 */
	...
	/** Method: getAllArmors
	 * Purpose: gets all armors from the Armor table
	...
	/**
	 * @param commonDamageReduction the commonDamageReduction to set
	 */
	...
	/**
	 * @param uncommonDamageReduction the uncommonDamageReduction to set
	 */
	...
	/**
	 * @param rareDamageReduction the rareDamageReduction to set
	 */
	...
	/**
	 * @param legendaryDamageReduction the legendaryDamageReduction to set
	 */
	...
	{
		return "Armor {\narmorID = " + armorID + "\narmorType = " + armorType + "\nequipSlot = " + equipSlot 
				+ "\ncommonDamageReduction = " + commonDamageReduction + "\nuncommonDamageReduction = " + uncommonDamageReduction 
