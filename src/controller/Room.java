...
public class Room
{
	...
	/**
	 * Method: getRoom Purpose: Retrieves a room based upon the supplied ID
	 * 
	 * @param id
	 * @return Room
	 * @throws SQLException
