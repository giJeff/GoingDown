 ...
 * 
 * @author: Jeff Graves
 * @version: 1.0 Course: Written: April 1, 2017
 *
...
public class GameDBCreate
{
	...
	/**
	 * Method: buildTables Purpose: Build all tables
	 * 
	 * @throws SQLException
	 * @return void
	 */
	...
	/**
	 * Method: buildRoom Purpose: Build the Room table and load data
	 * 
	 * @throws SQLException
	 * @return void
	 */
	...
	/**
	 * Method: buildMonster Purpose: Build the Monster table and load data
	 * 
	 * @throws SQLException
	 * @return void
	 */
	...
	/**
	 * Method: buildWeapon Purpose: Build the Weapon table and load data
	 * 
	 * @throws SQLException
	 * @return void
	 */
	...
	/**
	 * Method: buildArmor Purpose: Build the Armor table and load data
	 * 
	 * @throws SQLException
	 * @return void
	 */
	...
	public void buildPlayer() throws SQLException
	{
		...
		sql = "INSERT INTO Player(playerNumber, playerName, gender, hitPoints, minDamage, maxDamage, score, numKilled,"
				...
				+ "Values(1, 'Name', 'Male', 100, 40, 60, 0, 0, 0, 0, 100, 1, 0, 0, 0, 0)";
		sdb.updateDB(sql);
	...
	public void buildPuzzle() throws SQLException
	{
		...
		String sql = "CREATE TABLE Puzzle(puzzleNumber int Primary Key not null, puzzleQuestion text not null,"
				...
				+ " incorrectDamage int not null, correctReward int not null , solved int not null)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, incorrectDamage, correctReward, solved) "
				...
				+ "'a. Pink', 'b. Blue', 'c. Gray', 'd. Grey', 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. Every year', 'b. 5 years', 'c. 10 years', 'd. Once in a while', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(3, 'What belongs to you but others use it more than you do?', 'c', "
				+ "'a. Your phone', 'b. Your toilet', 'c. Your name', 'd. Your time', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(4, 'What can you keep but cannot share and once you share it you cant keep it anymore?', 'a', "
				+ "'a. A secret', 'b. Food', 'c. Homework answers', 'd. Your besties number', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) " + "Values(5, 'What has six eyes, but can not see?', 'a', "
				+ "'a. Three blind mice', 'b. A spider', 'c. A fly', 'd. A praying mantis', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(6, 'Whats 3/7 chicken, 2/3 cat, and 2/4 goat?', 'b', "
				+ "'a. A weird meal', 'b. Chicago', 'c. A science project gone wrong', null, 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) " + "Values(7, 'How can FIVE minus TWO equal 4?', 'a', "
				+ "'a. Roman Numerals', 'b. By magic', 'c. Not possible', 'd. I dont know', 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. History', 'b. A newspaper', 'c. Last weeks lunch', 'd. A memory', 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. A tree', 'b. A mountain', 'c. A valley', null, 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. A staircase', 'b. The temperature', 'c. A thermometer.', 'd. All of the above', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(12, 'What is harder to catch the faster you run?', 'b',"
				+ "'a. A ball', 'b. Your breath', 'c. A cheetah.', 'd. A break', 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. A plus sign', 'b. A dash', 'c. A decimal point', null, 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. A shooting star ', 'b. A blue moon', 'c. A raise in your paycheck.', 'd. M', 5, 10, 0)";
		sdb.updateDB(sql);
		...
		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				...
				+ "'a. 20 minutes', 'b. 30 minutes', 'c. 15 minutes', 'd. 10 minutes', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(22, 'If you look at the number on my face you will not find thirteen anyplace. What am I?', 'c',"
				+ "'a. Your face ', 'b. A book', 'c. A clock', null, 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(23, 'What is it that is always coming but never arrives?', 'd',"
				+ "'a. The pakage from Amazon', 'b. A raise in your paycheck', 'c. That A in chemistry', 'd. Tommorrow', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(24, 'Which plural form is incorrect: monkeys, cats, deers, giraffes?', 'c',"
				+ "'a. Cats ', 'b. Monkeys', 'c. Deers', 'd. Giraffes', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(25, 'What comes up when the rain comes down?', 'c',"
				+ "'a. The sun ', 'b. Sunscreen', 'c. An umbrella', null, 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) " + "Values(26, 'What gets wetter the more it drys?', 'd',"
				+ "'a. A pool ', 'b. The sun', 'c. An umbrella', 'd. A towel', 5, 10, 0)";
		sdb.updateDB(sql);

		sql = "INSERT INTO Puzzle(puzzleNumber, puzzleQuestion, puzzleAnswer, optA, optB, optC, optD, "
				+ "incorrectDamage, correctReward, solved) "
				+ "Values(27, 'What number can you take half of and leave nothing?', 'a',"
				+ "'a. 8', 'b. 4', 'c. 2', 'd. 9', 5, 10, 0)";
