 ...
 * 
 * @author: Jeff Graves
 * @version: 1.0 Course: ITEC 3860 Written: Feb 25, 2017
 *
...
abstract public class DB
{
	...
	/**
	 * Method: queryDB Purpose: read from the database
	 * 
	 * @param sql
	 * @throws SQLException
	 * @return ResultSet
	...
	/**
	 * Method: updateDB Purpose: Updates the database
	 * 
	 * @param SQL
	 * @throws SQLException
	 * @return boolean
	...
	/**
	 * Method: count Purpose: Gets the count of records in the specified table
	 * 
	 * @param table
	 * @return int
	 */
	...
	/**
	 * Method: getMaxValue Purpose: Gets max value for a particular field in a
	 * particular table
	 * 
	 * @param columnName
	 * @param table
	...
	public void savePlayerString(String table, String columnName, String newValue, String where, int index)
	{
		...
		try
		{
			...
			String sql = "UPDATE " + table + " Set " + columnName + " = " + newValue + " WHERE " + where + " = "
					+ index;
			sdb.updateDB(sql);
		}
		catch (SQLException sqe)
